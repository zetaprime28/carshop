...
<html lang="en">
  ...
  .bgbanner {
    position: relative;
    background-image: url('img/FERRARI_296-71890-scaled.jpg');
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto fs-5 fw-medium">
              ...
              <li class="nav-item">
                <a class="nav-link me-3 fw-bold text-warning" href="#">ferrari</a>
              </li>
              <li class="nav-item">
    ...
    <div class="bgbanner">
          ...
          <div class="container h-100">
              <div class="row h-100 justify-content-center align-items-center">
                  <div class="col-7 text-center">
                      <h5 class="display-6 fw-bold text-light">Ferrari</h5>
                      <p class="text-light">A manufacturer that needs no introduction. They built road cars to fund their racing habit, and the technology from their racing habit was fed back into their road cars. All sense of logic and reason is lost upon sight and sound. Pure automotive bliss.</p>
     ...
     <!---end banner--->
      <!---ferrari--->  
        ...
        <h4 class="mb-4 text-light fs-3">FERRARI</h4>
          <div class="row justify-content-center">
          <?php
                $sql = "select * from ferrari_tbl";
