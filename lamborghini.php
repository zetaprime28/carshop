...
<html lang="en">
  ...
  .bgbanner {
    position: relative;
    background-image: url('img/LAMBORGHINI_HURACAN-09221_bg.jpg');
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto fs-5 fw-medium">
              ...
              <li class="nav-item">
                <a class="nav-link me-3 fw-bold text-warning" href="#">lamborghini</a>
              </li>
              <li class="nav-item">
          ...
          <div class="container h-100">
              <div class="row h-100 justify-content-center align-items-center">
                  <div class="col-7 text-center">
                      <h5 class="display-6 fw-bold text-light">Lamborghini</h5>
                      <p class="text-light">Consistently outrageous, consistently fast, and consistently awesome, even though they might not always start consistently. Lamborghini is a true supercar company.</p>
     ...
     <!---end banner--->
      <!---lamborghini--->  
        ...
        <h4 class="mb-4 text-light fs-3">LAMBORGHINI</h4>
