...
<html lang="en">
  ...
  .bgbanner {
    position: relative;
    background-image: url('img/BMW_M4_GTS-67637-scaled.jpg');   
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto fs-5 fw-medium">
              ...
              <li class="nav-item">
                <a class="nav-link me-3 fw-bold text-warning" href="#">BMW</a>
              </li>
    ...
    <div class="bgbanner">
          ...
          <div class="container h-100">
              <div class="row h-100 justify-content-center align-items-center">
                  <div class="col-7 text-center">
                      <h5 class="display-6 fw-bold text-light">BMW</h5>
                      <p class="text-light">Stylish, practical, and excellent to drive.
                         BMW has consistently proven that sports car and sports sedan are
                          not mutually exclusive classifications.</p>
     ...
     <!---end banner--->
      <!---bmw--->  
        ...
        <h4 class="mb-4 text-light fs-3">BMW</h4>
          <div class="row justify-content-center">
          <?php
                $sql = "select * from bmw_tbl";
