...
<html lang="en">
  ...
  .bgbanner {
    position: relative;
    background-image: url('img/BUGATTI_CHIRON_PUR_SPORT-53170-scaled.jpg');
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto fs-5 fw-medium">
              ...
              <li class="nav-item">
                <a class="nav-link me-3 fw-bold text-warning" href="#">bugatti</a>
              </li>
              <li class="nav-item">
    ...
    <div class="bgbanner">
          ...
          <div class="container h-100">
              <div class="row h-100 justify-content-center align-items-center">
                  <div class="col-7 text-center">
                      <h5 class="display-6 fw-bold text-light">Bugatti</h5>
                      <p class="text-light">From Ettore's classic creations to Artioli's 1990s quad-turbo V12 insanity to VW's record-chasing cars, the Bugatti name has represented the upper echelons of the automotive world for over a century.</p>
     ...
     <!---end banner--->
      <!---bugatti--->  
        ...
        <h4 class="mb-4 text-light fs-3">BUGATTI</h4>
          <div class="row justify-content-center">
          <?php
                $sql = "select * from bugatti_tbl";
